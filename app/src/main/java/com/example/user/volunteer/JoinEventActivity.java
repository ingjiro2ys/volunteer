...
public class JoinEventActivity extends AppCompatActivity {
    ...
    private void initInstance() {
        ...
        listView = (ListView) findViewById(R.id.listViewUserJoin);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(JoinEventActivity.this, DetailActivity.class);
        ...
        //////// Refresh data
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipeRefreshLayoutUserJoin);
    ...
    private void reloadData() {
        ...
        //add
        Call<PhotoItemCollectionDao> call = HttpManager.getInstance().getService().loadJoin(map);
        call.enqueue(new Callback<PhotoItemCollectionDao>() {
            ...
            public void onResponse(Call<PhotoItemCollectionDao> call,
                ...
                if(response.isSuccessful()){
                    ...
                    //ลบข้างบน
                    Toast.makeText(JoinEventActivity.this,"Load Successful",
